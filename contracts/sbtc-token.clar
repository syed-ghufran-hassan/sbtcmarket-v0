...
;; DEFINE METADATA
(define-data-var token-uri (optional (string-utf8 256)) (some u"https://gaia.hiro.so/hub/1M19CV7cuRSEWzdfxAhiq6KSkDqHEqfoJt/sbtc-0-decimals.json"))
...
;; ---------------------------------------------------------
(begin
    (try! (ft-mint? sbtc u10000000000000000 (var-get contract-owner)))
)